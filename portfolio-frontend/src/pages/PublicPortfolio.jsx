            ...
            <div className="flex flex-wrap items-center justify-between gap-4 pt-4 border-t border-white/5">
              ...
              {profile.resumeUrl && (
                <button
                  ...
                  className="rounded-full bg-indigo-600 px-6 py-2 text-xs font-semibold text-white hover:bg-indigo-500 transition shadow shadow-indigo-600/30 flex items-center gap-1.5"
                >
